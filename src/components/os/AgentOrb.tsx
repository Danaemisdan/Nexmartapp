  ...
  return (
      ...
      <div className="relative flex items-center justify-center">
          <motion.div 
            ...
            className={`relative cursor-pointer transition-shadow duration-700 w-24 h-24 md:w-36 md:h-36 flex items-center justify-center ${isWorking || isTalking ? 'drop-shadow-[0_0_60px_rgba(59,130,246,0.5)]' : 'drop-shadow-[0_10px_30px_rgba(0,0,0,0.3)] hover:scale-105 hover:drop-shadow-[0_15px_35px_rgba(0,0,0,0.4)]'}`}
          >
