    ...
    return (
        <section className="relative w-full overflow-hidden bg-white pb-16 pt-8 md:pt-16 border-b border-gray-100">
            <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10 flex flex-col md:flex-row items-center justify-between">
                ...
                {/* Centered Content */}
                <div className="flex-1 max-w-4xl mx-auto text-center mt-12 mb-16 flex flex-col items-center">
                    <motion.div 
                    ...
                    <motion.h1 
                        ...
                        className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-gray-900 leading-[0.95] tracking-tight mb-6"
                    >
                        Shop Smarter.<br />
                    ...
                    <motion.p 
                        ...
                        className="text-gray-600 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-medium mb-10"
                    >
                    ...
                    >
                        <button className="w-full sm:w-auto flex items-center justify-center gap-3 bg-[#1e3a8a] text-white px-10 py-5 rounded-full font-bold text-xl hover:scale-105 active:scale-95 transition-all shadow-xl shadow-blue-900/20">
                    ...
                    <motion.div 
                        ...
                        className="mt-12 flex items-center justify-center gap-8 text-gray-500 text-sm font-bold"
                    >
