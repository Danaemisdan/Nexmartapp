            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
                {wishlistProducts.map((product, i) => (
                    <motion.div 
                        ...
                        className="cursor-pointer bg-white/5 border border-white/10 rounded-2xl p-4 flex flex-col group hover:bg-white/10 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 relative backdrop-blur-sm"
                    >
                        {/* Remove button */}
                        <button 
                        ...
                        <div className="flex flex-col flex-1">
                            <h3 className="text-sm font-bold text-white leading-tight mb-1 line-clamp-2">{product.title}</h3>
                            ...
                            <div className="mt-auto flex items-center justify-between">
                                ...
                                <button 
                                    ...
                                    className="w-8 h-8 rounded-full border-2 border-blue-400 text-blue-400 flex items-center justify-center hover:bg-blue-400 hover:text-white transition-colors shadow-[0_0_10px_rgba(96,165,250,0.3)]"
                                >
